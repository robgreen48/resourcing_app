...
describe HolidaysController do
  ...
  let(:valid_attributes) { { "days_off" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved holiday as @holiday" do
        ...
        post :create, {:holiday => { "days_off" => "invalid value" }}, valid_session
        assigns(:holiday).should be_a_new(Holiday)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested holiday" do
        ...
        Holiday.any_instance.should_receive(:update).with({ "days_off" => "1" })
        put :update, {:id => holiday.to_param, :holiday => { "days_off" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the holiday as @holiday" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Holiday.any_instance.stub(:save).and_return(false)
        put :update, {:id => holiday.to_param, :holiday => { "days_off" => "invalid value" }}, valid_session
        assigns(:holiday).should eq(holiday)
      end
